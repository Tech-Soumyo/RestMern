                ...
                >
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="mt-2 gap-1 flex items-center text-gray-600 dark:text-gray-400">
                      <MapPin size={16} />
                      <p className="text-sm">
                        City: <span className="font-medium">{"Kolkata"}</span>
                      </p>
                    </div>
                    <div className="mt-2 gap-1 flex items-center text-gray-600 dark:text-gray-400">
                      <Globe size={16} />
                    ...
                    <div className="flex gap-2 mt-4 flex-wrap">
                      {["Large", "Medium", "Regular"].map(
                        (cuisine: string, idx: number) => (
                          <Badge
                            key={idx}
                            className="font-medium px-2 py-1 rounded-full shadow-sm cursor-default"
                          >
                            {cuisine}
                          </Badge>
                        )
